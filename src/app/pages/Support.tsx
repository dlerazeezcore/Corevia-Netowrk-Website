...
export function Support() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden bg-[#f8f9fc]">
      <header className="sticky top-0 z-10 flex items-center gap-3 bg-white px-4 pb-4 shadow-[0_1px_3px_rgba(0,0,0,0.06)]" style={{ paddingTop: 'max(calc(env(safe-area-inset-top, 0px) + 12px), 1rem)' }}>
        <button
          className="flex h-9 w-9 items-center justify-center rounded-xl bg-gray-100 transition-colors hover:bg-gray-200 active:bg-gray-300"
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-[17px] font-semibold tracking-tight text-gray-900">Support</h1>
          <div className="flex items-center gap-1.5">
            <div className="w-1.5 h-1.5 rounded-full bg-emerald-500"></div>
            <p className="text-[12px] text-gray-500">Online · Typically replies instantly</p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="mx-auto flex h-full max-w-md flex-col items-center justify-center px-6 text-center">
            <div className="mb-6">
              ...
              <h2 className="mb-2 text-xl font-semibold text-gray-900">Log in to chat with support</h2>
          ...
          <div className="mx-auto flex h-full max-w-md flex-col items-center justify-center px-6 text-center">
            <div className="mb-6">
              ...
              <h2 className="mb-2 text-xl font-semibold text-gray-900">How can we help?</h2>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="w-full space-y-3">
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {QUICK_ACTIONS.map((action) => (
                  <button
                    key={action}
                    className="rounded-2xl bg-white border border-gray-200 hover:border-blue-300 hover:bg-blue-50 px-5 py-2.5 text-sm transition-all shadow-sm hover:shadow-md font-medium text-gray-700 hover:text-blue-600"
                    ...
                    >
                      <div
                        className={[
                          ...
                          outgoing ? "justify-end text-white/90" : "justify-start text-gray-500",
                        ].join(" ")}
                      >
                        {!outgoing ? (
                          <span className="inline-flex h-5 w-5 items-center justify-center rounded-full border border-gray-200 bg-gray-100 text-[10px] text-gray-700">
      ...
      <div className="safe-area-bottom sticky bottom-0 z-10 border-t border-gray-100 bg-white/95 backdrop-blur-md px-4 py-3">
        <div className="mx-auto max-w-2xl">
            ...
            <div className="mb-2 flex items-start gap-2">
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-gray-800 text-white hover:bg-gray-900"
                  type="button"
          ...
          <div className="flex items-end gap-2">
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gray-100 transition-colors hover:bg-gray-200 disabled:opacity-50"
              type="button"
            ...
            <div className="relative flex-1">
              <textarea
                ref={textareaRef}
                className="max-h-32 w-full resize-none rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-[16px] transition-all focus:border-blue-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/15"
                disabled={isSending || requiresAuth}

        ...
        <div className="max-w-sm w-full text-center">
          ...
          <div className="relative mb-8">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-32 h-32 bg-gradient-to-br from-blue-100 to-blue-200 rounded-full blur-2xl opacity-60"></div>
            </div>
          ...
          {/* Coming Soon Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 mb-6">
            ...
            <div className="space-y-3 text-left">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-gray-700">Browse thousands of hotels worldwide</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-primary mt-1.5 flex-shrink-0"></div>
                <p className="text-sm text-gray-700">Exclusive member rates and deals</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-primary mt-1.5 flex-shrink-0"></div>
                <p className="text-sm text-gray-700">Flexible cancellation options</p>
              </div>
            </div>
          </div>

    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Tulip Management</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-gray-200">
          <p className="text-xs text-gray-500 text-center">Tulip eSIM v1.0</p>
          <p className="text-xs text-gray-400 text-center mt-1">Corevia Network</p>
        </div>
      </aside>
        ...
        <header className="bg-white border-b border-gray-200 px-8 py-5 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Manage app configuration and settings</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <Button
              onClick={() => navigate("/")}
              className="gap-2 bg-gradient-to-r from-primary to-blue-600 hover:from-primary-hover hover:to-blue-700 shadow-md"
            >
  ...
  return (
    <Card className="p-8 shadow-sm border-gray-200">
          ...
          <div className="flex flex-wrap gap-2">
            {currentDestinations.map((code: string) => (
              <Badge
                key={code}
                variant="secondary"
                className="px-3 py-1.5 bg-blue-50 text-primary border-0 font-medium"
              >
                {code}
              </Badge>
            ))}
      ...
      <div className="border-t border-gray-200 pt-8 space-y-6">
        <div>
          <Label htmlFor="country-codes" className="text-sm font-medium text-gray-900">
        ...
        <div className="flex gap-3">
          <Button
            ...
            className="gap-2 bg-gradient-to-r from-primary to-blue-600 hover:from-primary-hover hover:to-blue-700"
          >
            {loading ? (
              <>
                <Loader2 className="w-4 h-4 animate-spin" />
    ...
    <Card className="p-8 shadow-sm border-gray-200">
      ...
      <div className="mb-8">
        ...
        {currencyLoading ? (
          ...
          <div className="flex flex-wrap gap-2">
            <Badge variant="secondary" className="px-3 py-1.5 bg-blue-50 text-primary border-0">
      ...
      <div className="border-t border-gray-200 pt-8 space-y-6">
        <div className="flex items-center gap-3">
          ...
          />
          <Label htmlFor="enable-iqd" className="text-sm font-medium text-gray-900 cursor-pointer">
            Enable IQD Currency
          </Label>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            <Label htmlFor="exchange-rate" className="text-sm font-medium text-gray-900">
          ...
          <div>
            <Label htmlFor="markup-percent" className="text-sm font-medium text-gray-900">
              Markup Percent
            </Label>
            <Input
              id="markup-percent"
    ...
    <Card className="p-8 shadow-sm border-gray-200">
      ...
      <div className="border-t border-gray-200 pt-8 space-y-6">
        <div className="flex items-center gap-3">
          ...
          />
          <Label htmlFor="home-tutorial-enabled" className="text-sm font-medium text-gray-900 cursor-pointer">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            <Label htmlFor="tutorial-card-title" className="text-sm font-medium text-gray-900">
              Card Title
            </Label>
            <Input
          ...
          <div>
            <Label htmlFor="tutorial-modal-title" className="text-sm font-medium text-gray-900">
              Modal Title
            </Label>
            <Input
        ...
        <div>
          <Label htmlFor="tutorial-card-subtitle" className="text-sm font-medium text-gray-900">
            Card Subtitle
          </Label>
          <Input
        ...
        <div className="grid grid-cols-2 gap-6 pt-4">
          {/* iPhone Tutorial */}
          <div className="space-y-4 rounded-xl border border-gray-200 p-6 bg-gray-50/50">
            ...
            <div>
              <Label htmlFor="tutorial-iphone-video-url" className="text-sm font-medium text-gray-900">
                Video URL
              </Label>
              <Input
            ...
            <div>
              <Label htmlFor="tutorial-iphone-thumbnail-url" className="text-sm font-medium text-gray-900">
                Thumbnail URL
              </Label>
              <Input
            ...
            <div>
              <Label htmlFor="tutorial-iphone-duration" className="text-sm font-medium text-gray-900">
                Duration Label
              </Label>
              <Input
            ...
            <div>
              <Label htmlFor="tutorial-iphone-description" className="text-sm font-medium text-gray-900">
                Description
              </Label>
              <Textarea
          ...
          <div className="space-y-4 rounded-xl border border-gray-200 p-6 bg-gray-50/50">
            ...
            <div>
              <Label htmlFor="tutorial-android-video-url" className="text-sm font-medium text-gray-900">
                Video URL
              </Label>
              <Input
            ...
            <div>
              <Label htmlFor="tutorial-android-thumbnail-url" className="text-sm font-medium text-gray-900">
                Thumbnail URL
              </Label>
              <Input
            ...
            <div>
              <Label htmlFor="tutorial-android-duration" className="text-sm font-medium text-gray-900">
                Duration Label
              </Label>
              <Input
            ...
            <div>
              <Label htmlFor="tutorial-android-description" className="text-sm font-medium text-gray-900">
                Description
              </Label>
              <Textarea
...
function PushNotificationsSection(props: any) {
  ...
  return (
    <Card className="p-8 shadow-sm border-gray-200">
      {/* Current Reach */}
      <div className="mb-8">
        <h3 className="text-sm font-semibold text-gray-900 mb-4">Current Reach</h3>
        {pushSummaryLoading ? (
          <div className="flex items-center gap-2 text-sm text-gray-500">
            <Loader2 className="w-4 h-4 animate-spin" />
            Loading...
      ...
      <div className="border-t border-gray-200 pt-8 space-y-6">
        <div className="grid grid-cols-2 gap-6">
          <div>
            <Label htmlFor="push-kind" className="text-sm font-medium text-gray-900">
              Notification Type
            </Label>
          ...
          <div>
            <Label className="text-sm font-medium text-gray-900">Target Mode</Label>
        ...
        {pushTargetMode === "audience" ? (
          <div>
            <Label htmlFor="push-audience" className="text-sm font-medium text-gray-900">
              Audience
            </Label>
          ...
          <div className="space-y-4">
            <div>
              <Label className="text-sm font-medium text-gray-900">
                ...
                {pushTargetUserIds.length > 0 && (
                  <Badge variant="secondary" className="ml-2 bg-blue-50 text-primary border-0">
            ...
            <div className="rounded-lg border border-gray-200 max-h-64 overflow-y-auto bg-white">
                  ...
                  .map((user) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex w-full items-center gap-3 px-4 py-3 text-left text-sm border-b last:border-b-0 transition-colors ${
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="font-medium truncate text-gray-900">{user.name || "User"}</div>
        ...
        <div>
          <Label htmlFor="push-title" className="text-sm font-medium text-gray-900">
            Title
          </Label>
          <Input
            id="push-title"
        ...
        <div>
          <Label htmlFor="push-body" className="text-sm font-medium text-gray-900">
            Message
          </Label>
          <Textarea
            id="push-body"
        ...
        <div>
          <Label htmlFor="push-route" className="text-sm font-medium text-gray-900">
            Open Route
          </Label>
          <Input
            id="push-route"
        ...
        <div className="pt-6 border-t border-gray-200 space-y-4">
          <div className="flex items-start gap-3 p-4 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#1967D2] to-[#114A99] flex items-center justify-center flex-shrink-0">
              <Send className="w-5 h-5 text-white" />
            </div>
            <div className="flex-1 min-w-0">
              <h4 className="text-sm font-semibold text-gray-900">One-Click App Update Push</h4>
          ...
          <div className="space-y-4 pt-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="app-update-title" className="text-sm font-medium text-gray-900">
                  Update Title
                </Label>
                <Input
                  id="app-update-title"
              ...
              <div>
                <Label htmlFor="app-update-body" className="text-sm font-medium text-gray-900">
                  Update Message
                </Label>
                <Input
                  id="app-update-body"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="app-update-ios" className="text-sm font-medium text-gray-900">
                  App Store URL
                </Label>
                <Input
                  id="app-update-ios"
              ...
              <div>
                <Label htmlFor="app-update-android" className="text-sm font-medium text-gray-900">
                  Play Store URL
                </Label>
                <Input
            ...
            <div className="flex items-center gap-3 pt-2">
              <Button
                ...
                className="gap-2 bg-gradient-to-r from-[#1967D2] to-[#114A99] hover:from-[#114A99] hover:to-[#0D3A7A]"
              >
                {appUpdateSending ? (
                  <>
                    <Loader2 className="w-4 h-4 animate-spin" />
            ...
            {appUpdateLastResult ? (
              <div className="rounded-lg border p-4 space-y-2.5" style={{
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm" style={{
                  ...
                  <span className="font-medium text-emerald-700">Success: {appUpdateLastResult.successCount}</span>
                  <span className="text-gray-400">•</span>
                  <span className="font-medium text-red-700">Failure: {appUpdateLastResult.failureCount}</span>
                </div>
    ...
    <Card className="p-8 shadow-sm border-gray-200">
            ...
            {currentWhitelist.length > 0 ? (
              currentWhitelist.map((code: string) => (
                <Badge
                  key={code}
                  variant="secondary"
                  className="px-3 py-1.5 bg-blue-50 text-primary border-0"
                >
                  {code}
                </Badge>
              ))
            ) : (
              <Badge variant="secondary" className="px-3 py-1.5 bg-gray-100 text-gray-600 border-0">
      ...
      <div className="border-t border-gray-200 pt-8 space-y-6">
        <div className="flex items-center gap-3">
          ...
          />
          <Label htmlFor="enable-whitelist" className="text-sm font-medium text-gray-900 cursor-pointer">
            Enable Country Whitelist
          </Label>
        </div>

        <div>
          <Label htmlFor="whitelist-codes" className="text-sm font-medium text-gray-900">
            Country Codes (comma-separated)
          </Label>
          <Input
            id="whitelist-codes"
...
function SuperAdminSettingsSection(props: any) {
  ...
  return (
    <Card className="p-8 shadow-sm border-gray-200">
          ...
          <div className="flex flex-wrap gap-2">
            {currentAdmins.length > 0 ? (
              currentAdmins.map((phone: string) => (
                <div
                  key={phone}
                  className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 text-primary rounded-full font-medium"
                >
                  {phone}
                  <button
                    onClick={() => handleRemoveSuperAdmin(phone)}
                    disabled={adminLoading}
                    className="ml-1 hover:bg-red-100 rounded-full p-1 transition-colors disabled:opacity-50"
                  >
      ...
      <div className="border-t border-gray-200 pt-8 space-y-6">
        <div>
          <Label htmlFor="new-admin-phone" className="text-sm font-medium text-gray-900">
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            {user.hasLoyalty ? (
                              <Badge variant="default" className="text-xs">Loyalty</Badge>
                            ) : null}
                          </div>
                          ...
                          <TableCell className="text-right">
                            <div className="relative inline-block text-left">
                              ...
                              {openActionMenuUserId === user.id && (
                                <div className="absolute right-0 z-20 mt-2 min-w-[12rem] rounded-md border bg-white p-1 shadow-lg">
                                  <button
                                    type="button"
                                    onClick={() => {
                                      setOpenActionMenuUserId("");
                                    ...
                                    className="flex w-full items-center gap-2 rounded-sm px-3 py-2 text-left text-sm hover:bg-gray-100"
                                  >
                                    <Trash2 className="w-4 h-4" />
                                    Delete user
                                  </button>
...
function CountryCodesReferenceSection() {
  return (
    <Card className="p-8 shadow-sm border-gray-200">
      <h3 className="text-sm font-semibold text-gray-900 mb-6">Common Country Codes Reference</h3>
      <div className="grid grid-cols-3 gap-x-8 gap-y-3 text-sm">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">IQ</span>
            <span className="text-gray-600">Iraq</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">US</span>
            <span className="text-gray-600">United States</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">GB</span>
            <span className="text-gray-600">United Kingdom</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">DE</span>
            <span className="text-gray-600">Germany</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">FR</span>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">ES</span>
            <span className="text-gray-600">Spain</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">NL</span>
            <span className="text-gray-600">Netherlands</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">SA</span>
            <span className="text-gray-600">Saudi Arabia</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">AE</span>
            <span className="text-gray-600">UAE</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">QA</span>
            <span className="text-gray-600">Qatar</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">KW</span>
            <span className="text-gray-600">Kuwait</span>
          </div>
        </div>
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">BH</span>
            <span className="text-gray-600">Bahrain</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">OM</span>
            <span className="text-gray-600">Oman</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">JO</span>
            <span className="text-gray-600">Jordan</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">TR</span>
            <span className="text-gray-600">Turkey</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">EG</span>
            <span className="text-gray-600">Egypt</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-primary">JP</span>

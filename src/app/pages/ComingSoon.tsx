  ...
  return (
    <div className="min-h-full bg-gradient-to-b from-gray-50 via-blue-50/30 to-purple-50/30 pb-6">
      ...
      <div className="px-6 py-8 space-y-6">
        {/* Main Card */}
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-white to-blue-50/50 border-0 shadow-2xl p-8">
          ...
          <div className="relative text-center">
            ...
            {/* Title */}
            <h2 className="text-2xl font-bold mb-3 bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">
              {service}
            </h2>
            ...
            {/* Launch Timeline */}
            <div className="inline-flex items-center gap-3 px-5 py-3 rounded-full bg-gradient-to-r from-blue-100 to-purple-100 border border-blue-200 mb-8">
        ...
        <div className="bg-white rounded-2xl border-0 shadow-lg p-6">
          ...
          <div className="space-y-3">
            {features.map((feature, index) => (
              <div key={index} className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-gray-50 to-blue-50/30 hover:from-blue-50 hover:to-purple-50/30 transition-all">

...
export function Plans() {
  ...
  if (selectedDestination) {
    return (
      <div className="min-h-full bg-gradient-to-b from-gray-50 to-white pb-24">
        ...
        <div className="relative px-6 pt-12 pb-8 bg-gradient-to-br from-[#1967D2] via-[#1557B0] to-[#114A99] text-white overflow-hidden texture-noise">
          ...
          <div className="relative z-10">
            ...
            <Card className="relative overflow-hidden border-0 shadow-[0_8px_24px_rgba(0,0,0,0.12),0_2px_6px_rgba(0,0,0,0.08)]">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-purple-500/5 to-transparent"></div>
              <div className="relative flex items-center gap-3 p-4">
                <div className="w-16 h-16 rounded-xl bg-white shadow-[0_4px_12px_rgba(0,0,0,0.08)] flex items-center justify-center flex-shrink-0">
                  <CountryFlag
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-lg mb-0.5 tracking-tight">{selectedDestination.name}</h3>
                  ...
                  {selectedDestination.type === "regional" && allIncludedCountries.length > 0 && (
                    <button
                      type="button"
                      className="inline-flex items-center gap-1.5 mt-2 px-3 py-1.5 rounded-full text-xs font-semibold bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 hover:from-blue-100 hover:to-indigo-100 hover:scale-105 active:scale-95 transition-all shadow-sm border border-blue-200/50"
                      onClick={() => {
                  ...
                  {group.offers.map((bundle) => {
                    ...
                    return (
                      <label
                        ...
                        className={`
                          relative flex items-center gap-4 p-5 bg-white rounded-2xl cursor-pointer 
                          transition-all duration-200 shadow-sm overflow-hidden
                          ${isSelected 
                            ? 'border-2 border-primary shadow-xl ring-4 ring-primary/10' 
                            : 'border-2 border-gray-100 hover:border-gray-200 hover:shadow-lg hover:scale-[1.01]'
                          }
                        `}
                      >
                        {isSelected && (
                        ...
                        <div className="flex-1 min-w-0 relative z-10">
                          <div className="flex items-center justify-between gap-3">
                            <div className="flex-1 min-w-0">
                              <div className="text-lg font-semibold mb-1.5 text-gray-900">{bundle.dataLabel}</div>
                              {bundle.isPerDay && (
                                <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-gradient-to-r from-blue-100 to-purple-100 text-blue-900">
                                  Daily allowance
                                </span>
                              )}
                            </div>
                            <div className="text-right flex-shrink-0">
                              <div className="text-xl font-bold text-gray-900 whitespace-nowrap mb-0.5">
        ...
        {/* 
          ...
          ============================================
        */}
        <div className="fixed bottom-20 left-0 right-0 bg-white/100 backdrop-blur-none border-t border-gray-200 shadow-2xl pointer-events-none z-40">
  ...
  return (
    <div className="min-h-full bg-gradient-to-b from-gray-50 to-white pb-6">
      ...
      <section className="px-6 mt-6">
        {/* Tab Switcher */}
        <div className="flex bg-gray-100/80 backdrop-blur-sm rounded-xl p-1 mb-5 shadow-inner">
          <button
            onClick={() => handleTabChange("countries")}
            className={`flex-1 py-2.5 px-4 rounded-lg text-sm font-semibold transition-all duration-200 ${
              activeTab === "country" && explicitTab === "countries"
                ? "bg-white text-gray-900 shadow-[0_2px_8px_rgba(0,0,0,0.08)] scale-[1.02]"
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-lg mb-1 tracking-tight">{sectionTitle}</h2>
        ...
        <div className="space-y-3">
          {isLoadingDestinations ? (
            <Card className="p-8 text-center bg-white shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
...
function IncludedCountriesSheet({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      {/* Sheet */}
      <div className="relative w-full max-w-lg bg-white rounded-t-3xl shadow-2xl max-h-[85vh] flex flex-col animate-in slide-in-from-bottom duration-300">
        {/* Handle */}
        ...
        <div className="px-6 pb-4 pt-2 border-b border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Included Countries</h3>
              <div className="flex items-center gap-2 mt-1">
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700">
        ...
        <div className="px-6 py-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-10 pl-9 pr-4 rounded-xl bg-gray-50 border border-gray-200 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/30"
            />
          </div>
        </div>
          ...
          {filtered.length === 0 ? (
            ...
            <div className="divide-y divide-gray-100">
              {filtered.map((country, idx) => (
                ...
                >
                  <div className="w-9 h-6 rounded-md overflow-hidden shadow-sm border border-gray-200/60 flex-shrink-0 bg-gray-50 flex items-center justify-center">
                    <CountryFlag
                      code={country.code}
                      className="w-full h-full object-cover"
                    />
                  ...
                  {country.code && (
                    <span className="text-[11px] text-gray-400 ml-auto font-mono">{country.code}</span>
                  )}
                </div>
              ))}
            </div>

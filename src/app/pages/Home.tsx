  ...
  return (
    <div className="min-h-full bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="px-6 py-6">
        ...
        <section>
          <div className="mb-4">
            <h2 className="mb-1">Explore Services</h2>
          ...
          <div className="space-y-3">
            ...
            >
              <div className="relative bg-white rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.04),0_4px_16px_rgba(0,0,0,0.06)] hover:shadow-[0_8px_16px_rgba(0,0,0,0.08),0_12px_32px_rgba(0,0,0,0.12)] transition-all duration-300 active:scale-[0.98] overflow-hidden border border-gray-100/50">
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-full -translate-y-8 translate-x-8 opacity-60 group-hover:opacity-80 transition-opacity"></div>
                ...
                <div className="relative p-4 flex items-center gap-4">
                  ...
                  <div className="flex-1 text-left min-w-0">
                    <h3 className="font-semibold text-gray-900 mb-0.5 tracking-tight">eSIM Plans</h3>
                    <p className="text-xs text-gray-600 font-medium">Browse global data plans</p>
                  </div>
                  <div className="flex-shrink-0">
            ...
            >
              <div className="relative bg-white rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.04),0_4px_16px_rgba(0,0,0,0.06)] hover:shadow-[0_8px_16px_rgba(0,0,0,0.08),0_12px_32px_rgba(0,0,0,0.12)] transition-all duration-300 active:scale-[0.98] overflow-hidden border border-gray-100/50">
                ...
                <div className="relative p-4 flex items-center gap-4">
                  ...
                  <div className="flex-1 text-left min-w-0">
                    <h3 className="font-semibold text-gray-900 mb-0.5 tracking-tight">Flights</h3>
                    <p className="text-xs text-gray-600 font-medium">Book your next adventure</p>
                  </div>
                  <div className="flex-shrink-0">
                    <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-primary group-hover:translate-x-0.5 transition-all" />
                  </div>
            ...
            >
              <div className="relative bg-white rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.04),0_4px_16px_rgba(0,0,0,0.06)] hover:shadow-[0_8px_16px_rgba(0,0,0,0.08),0_12px_32px_rgba(0,0,0,0.12)] transition-all duration-300 active:scale-[0.98] overflow-hidden border border-gray-100/50">
                ...
                <div className="relative p-4 flex items-center gap-4">
                  ...
                  <div className="flex-1 text-left min-w-0">
                    <h3 className="font-semibold text-gray-900 mb-0.5 tracking-tight">Hotels</h3>
                    <p className="text-xs text-gray-600 font-medium">Find perfect accommodations</p>
                  </div>
                  <div className="flex-shrink-0">
                    <div className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-gradient-to-r from-blue-50 to-blue-100/80 border border-blue-200/60 shadow-sm">
                      <span className="text-[10px] font-semibold text-blue-700">Soon</span>
                    </div>
                  </div>
                </div>
              </div>

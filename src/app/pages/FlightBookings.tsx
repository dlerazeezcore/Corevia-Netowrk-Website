        ...
        <div className="max-w-sm w-full text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 mb-8">
            ...
            <div className="text-left">
              <p className="text-xs text-gray-600">Flight Booking</p>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 mb-6">
            ...
            <div className="space-y-3 text-left">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-gray-700">Compare prices from multiple airlines</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-primary mt-1.5 flex-shrink-0"></div>
              ...
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-primary mt-1.5 flex-shrink-0"></div>
                <p className="text-sm text-gray-700">Manage all bookings in one place</p>
              </div>
            </div>
          </div>

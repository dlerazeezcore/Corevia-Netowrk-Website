        ...
        <div className="space-y-3">
          {services.map((svc) => {
            ...
            return (
              ...
              >
                <div
                  className={`relative rounded-2xl border ${svc.borderAccent} ${svc.bgAccent}/40 hover:shadow-md transition-all active:scale-[0.98] overflow-hidden`}
                >
                  <div className="relative p-4 flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-gray-900 mb-0.5">{svc.title}</h3>

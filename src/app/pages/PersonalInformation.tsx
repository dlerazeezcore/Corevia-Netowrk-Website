...
export function PersonalInformation() {
  ...
  return (
    <div className="min-h-full bg-gradient-to-b from-gray-50 via-blue-50/30 to-purple-50/30 pb-4">
      ...
      <section className="px-6 py-4 space-y-4">
        <Card className="divide-y border-0 shadow-lg overflow-hidden">
          <EditableInfoRow
      ...
      {isAuthenticated ? (
        <section className="px-6">
          <Card className="p-4 border-0 shadow-lg relative overflow-hidden">
...
function EditableInfoRow({
  ...
  return (
    <div className="flex items-center gap-4 p-4 hover:bg-muted/20 transition-colors">
      ...
      <button
        onClick={onEdit}
        className="w-9 h-9 rounded-lg bg-blue-50 hover:bg-blue-100 flex items-center justify-center transition-colors flex-shrink-0"
      >

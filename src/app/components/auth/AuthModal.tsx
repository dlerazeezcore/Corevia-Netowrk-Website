                ...
                <div className="flex gap-2">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="h-12 px-3 flex items-center gap-2 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 transition-colors shadow-sm"
                    >
                      <CountryFlag
                    ...
                    {showCountryCodeDropdown && (
                      <div className="absolute top-full left-0 mt-1 w-72 max-h-60 overflow-y-auto bg-white border border-gray-200 rounded-xl shadow-xl z-50">
...
function MethodCard({
  ...
  return (
    <button
      onClick={onClick}
      className="w-full p-4 rounded-xl border-0 shadow-lg bg-white hover:shadow-xl transition-all duration-200 hover:-translate-y-0.5 text-left"
    >

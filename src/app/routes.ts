...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "flights", lazy: lazyComponent(() => import("./pages/FlightSearch"), "FlightSearch") },
      { path: "flights/results", lazy: lazyComponent(() => import("./pages/FlightResults"), "FlightResults") },
